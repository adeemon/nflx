...
const cartIcon = () => (<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function CartIcon (props: Partial<CustomIconComponentProps>) {
    const cartProductsAmount = useAppSelector(selectCartProductsAmount);

    return (
        <div className={styles.container}>
            <div className={styles.button}>
                <Icon component={cartIcon} {...props} />
            </div>
