...
import { selectCartProducts, selectCartProductsAmount } from '../slices/CartSlice';
import { useAppSelector } from '../store/store';
import styles from '../styles/counterIcon.module.scss';
import Icon from '@ant-design/icons';
import type { CustomIconComponentProps } from '@ant-design/icons/lib/components/Icon';

const favouriteIcon = () => (<svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function FavouriteIcon (props: Partial<CustomIconComponentProps>) {
    const favouritesProductsAmount = 2;

    return (
        <div className={styles.container}>
            <div className={styles.button}>
                <Icon component={favouriteIcon} {...props} />
            </div>
            <div className={styles.counter}>
            {favouritesProductsAmount}
            </div>
        </div>
    )
}